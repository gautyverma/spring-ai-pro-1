package com.matuga.ai.a4_multimodal.audio;
...
public class AudioGeneration {
  ...
  public ResponseEntity<byte[]> generateSpeech(
      @RequestParam(defaultValue = "It's a great time to be a Java & Spring Developer!")
          String text) {
    ...
    var options =
        OpenAiAudioSpeechOptions.builder()
            ...
            .voice(
                OpenAiAudioApi.SpeechRequest.Voice.ALLOY) // ALLOY, ECHO, FABLE, ONYX, NOVA, SHIMMER
