package com.matuga.ai.a8_tools.b2_action;
...
public class TaskManagementTools {
  ...
  public record TaskResult(
      Long taskId, String title, String status, String assignee, String message) {}
  ...
  private record Task(
      Long id, String title, String description, String assignee, TaskStatus status) {}
  ...
  public TaskResult createTask(String title, String description, String assignee) {
    ...
    TaskResult object = new TaskResult(
            taskId,
            title,
            "PENDING",
            assignee,
  ...
  public TaskResult assignTask(Long taskId, String newAssignee) {
    ...
    return new TaskResult(
        ...
        newAssignee,
        "Task reassigned to " + newAssignee);
  }
}
